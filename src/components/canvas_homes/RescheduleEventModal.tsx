...
const RescheduleEventModal: React.FC<RescheduleEventModalProps> = ({
    ...
    // Agent details (replace with actual data from context)
    ...
    return (
        <>
            ...
            {/* Modal Container */}
            <div className='fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white z-50 rounded-lg shadow-xl mx-4'>
