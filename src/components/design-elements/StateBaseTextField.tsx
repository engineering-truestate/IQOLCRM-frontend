  ...
  return (
    <div className={`${fullWidth ? "w-full" : ""}`}>
      ...
      <div className="relative">
        ...
        >
          {leftIcon && <span className={`ml-3 ${disabled ? "text-gray-300" : "text-gray-400"}`}>{leftIcon}</span>}

          <input
            className={`flex-1 outline-none bg-transparent px-3 py-2 text-sm ${
              disabled ? "text-gray-400 placeholder-gray-300 cursor-not-allowed" : "text-gray-900 placeholder-gray-400"
            } ${leftIcon ? "pl-2" : ""}`}
            disabled={disabled}
          ...
          {suffix && <span className={`text-sm ${disabled ? "text-gray-300" : "text-gray-500"} mr-3`}>{suffix}</span>}
          ...
          {hasDropdown && (
            <div className="relative">
              ...
              >
                ...
                <img
                src="/icons/design_elements_icons/arrow-down.svg"
                alt="Chevron Down"
          ...
          {rightAddon && <span className={`mr-3 ${disabled ? "text-gray-300" : "text-gray-400"}`}>{rightAddon}</span>}
        </div>
      </div>
